                ...
                <div class="hidden sm:ml-6 sm:block w-full">
                    <ul class="flex items-center justify-between">
                        <div class="flex space-x-4 items-center ml-5">
                            <li><a href="<?= PUBLIC_URL ?>/schedule" class="text-sm font-medium text-slate-100 hover:text-slate-300 transition-all" aria-current="page">Schedule</a></li>
                        ...
                        <div class="flex space-x-4 items-center">
                            ...
                            <?php else: ?>
                                ...
                                <?php else: ?>
                                    <p class="font-medium text-xl"> Hello, <?= ucfirst($user->username) ?>!</p>
                                <?php endif; ?>
